                    ...
                    (o = [
                      ...
                      },
                      {
                        ...
                        value: function () {
                          ...
                          (o || n) &&
                            ...
                            (this.switchPos.x = o),
                            (this.switchPos.y = n),
                            (i.default.one(".vc-switch").style.userSelect =
                              "none"),
                      ...
                      },
                      {
                        ...
                        value: function () {
                          ...
                          let nMouseDownTimestamp = 0;
                          i.default.bind(t, "mousedown", function (t) {
                            isMouseDown = true;
                            setTimeout(() => {
                              isMouseDown = false;
                            ...
                            nMouseDownTimestamp = new Date().getTime();
                            // console.log("mousedown", t);
                            // (e.switchPos.startX = t.touches[0].pageX),
                            //   (e.switchPos.startY = t.touches[0].pageY);
                            e.switchPos.startX = t.clientX;
                            e.switchPos.startY = t.clientY;
                          }),
                            i.default.bind(t, "mouseup", function (t) {
                              isMouseDown = false;
                              const nTimestampNow = new Date().getTime();
                              if (nTimestampNow - nMouseDownTimestamp <= 300) {
                                e.show();
                              }
                            ...
                            i.default.bind(t, "mousemove", function (o) {
                              if (isMouseDown) {
                                // console.log("mousemove", o);
                                var n = o.clientX - e.switchPos.startX,
                                  r = o.clientY - e.switchPos.startY,
                                  i = e.switchPos.x - n,
                                  a = e.switchPos.y - r;
                                i + t.offsetWidth >
                                  document.documentElement.offsetWidth &&
                            ...
                            i.default.bind(t, "onmousemove", function (o) {
